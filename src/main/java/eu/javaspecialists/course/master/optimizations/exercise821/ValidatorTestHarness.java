package eu.javaspecialists.course.master.optimizations.exercise821;
...
// 1. run with -showversion -server -Xmx500m -Xloggc:server.vgc
// 2. run with -showversion -client -Xmx500m -Xloggc:client.vgc
// 3. run with -showversion -server -Xmx500m -Xcomp -Xloggc:server_comp.vgc
// 4. run with -showversion -client -Xmx500m -Xcomp -Xloggc:client_comp.vgc
// 5. run with -showversion -server -Xmx500m -Xint -Xloggc:server_int.vgc

// 6. run with -showversion -client -Xmx500m -Xint -Xloggc:client_int.vgc
